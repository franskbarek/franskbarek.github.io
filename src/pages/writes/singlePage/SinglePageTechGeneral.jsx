...
import { WriteTechGeneralSinglePageContext } from "../../../context/WriteTechGeneralSinglePageContext";
import SkeletonLoadingSinglePage from "../../../utils/SkeletonLoadingSinglePage";
import "./singlePage.css";

export default function SinglePage() {
  const { title, releaseDate, readTime, author, description, image, loading } = useContext(WriteTechGeneralSinglePageContext);
    ...
    <div className="singlePage-container">
      ...
      <div className="singlePage-topbar">
        <Breadcrumbs className="bread" aria-label="breadcrumb">
          ...
          <Link className="linkNew" underline="hover" to="/writes-group/tech-general">
